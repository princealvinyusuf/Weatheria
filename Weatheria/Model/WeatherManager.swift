...
//  Weatheria
//
//  Created by Prince Alvin Yusuf on 22/04/20.
...
struct WeatherManager {
    let weatherURL = "https://api.openweathermap.org/data/2.5/weather?appid=672c755f23a33bb55957fa39f5d6e5fa&units=metric"
